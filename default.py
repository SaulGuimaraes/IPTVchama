...
url_menu = 'https://pastebin.com/raw/2Avy07FX'
##############################################################################
...
welcome_description = 'Descrição do Addon\n\n[B][COLOR white]Versão: [/COLOR][COLOR magenta]1.0.0[/COLOR][/B]\n\n[B][COLOR yellow]Doações:[/COLOR][/B] [COLOR violet]Link-da-doação do bit.ly[/COLOR]'
##############################################################################
